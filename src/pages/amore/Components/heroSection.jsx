  ...
  return (
    ...
    <header className="container text-white bg-background-primary h-[960px] flex flex-col items-center pt-10 p-x-20">
      <nav className="bg-fourth w-[751px] h-[66px] rounded-4xl">
        <ul className="w-[751px] h-[66px] flex items-center justify-between text-sm px-4">
          ...
          <li className="flex gap-x-2">
            <a href="#" className="bg-secondary w-[125px] h-[48px]  rounded-4xl flex justify-center items-center">Oturum Aç</a>

            <a href="#" className="bg-primary w-[125px] h-[48px]  rounded-4xl flex justify-center items-center">
              Kayıt Ol
            </a>
          </li>
      ...
      <section className="mt-16 flex flex-col items-center">
        <h2 className="text-black text-6xl font-thin">
          Tadı Damağında Kalacak
        </h2>
        <h2 className="text-black text-6xl font-bold mt-4">
          Sohbet Et ve Flörtleş
        </h2>
        <div className="flex gap-4 mt-10">
          ...
          <div className="bg-black flex justify-center items-center h-[55px] w-[182.5px] text-xs rounded-2xl">
            ...
            >
              <path
                d="M11.8748 12.3081L1.93982 22.8524C1.94075 22.8543 1.94075 22.8571 1.94169 22.859C2.24682 24.0039 3.29192 24.8465 4.53297 24.8465C5.02939 24.8465 5.49502 24.7122 5.8944 24.477L5.92613 24.4583L17.1087 18.0058L11.8748 12.3081Z"
                fill="#EA4335"
              />
              <path
                d="M21.9254 10.5126L21.916 10.5061L17.088 7.70767L11.6489 12.5478L17.1076 18.0047L21.9095 15.2343C22.7512 14.7789 23.3232 13.8915 23.3232 12.8688C23.3232 11.8517 22.7596 10.9689 21.9254 10.5126Z"
                fill="#FBBC04"
              />
              <path
                d="M1.93959 2.8397C1.87987 3.05992 1.84814 3.29133 1.84814 3.53021V22.1628C1.84814 22.4017 1.87987 22.6331 1.94052 22.8524L12.2161 12.5778L1.93959 2.8397Z"
                fill="#4285F4"
              />
              <path
                d="M11.9481 12.8465L17.0896 7.70592L5.9201 1.23003C5.51419 0.986487 5.04016 0.846519 4.53348 0.846519C3.29242 0.846519 2.24546 1.691 1.94032 2.83687L1.93939 2.83967L11.9481 12.8465Z"
                fill="#34A853"
              />
            </svg>
      ...
      <section className="relative mt-10">
        <div className="w-[475px] h-[475px] bg-third rounded-full relative overflow-hidden">
          <img
            src={Image1}
            alt="phone"
            className="h-full w-full transform scale-x-[-1] absolute top-20 right-10 object-contain"
          />
          <img
            alt="phone"
            src={Image2}
            className="object-contain h-[389px] w-[170px] z-10 absolute left-[165px] top-[65px]"
          />
        </div>

        <div className="bg-primary w-[307px] h-[152px] rounded-3xl flex flex-col items-start justify-center p-6 absolute bottom-[180px] left-[-400px] transform rotate-[-6.64deg]">
          <h5 className="text-3xl">Sadece gerçek insanlar</h5>
          <p className="text-sm">Amore&apos;da sahte hesaplara yer yok</p>
        </div>

        <div className="bg-secondary w-[307px] h-[152px] rounded-3xl flex flex-col items-center justify-center absolute  bottom-[180px] right-[-350px] ransform -rotate-[-6.64deg]">
          <h5 className="text-2xl font-light">Tanış,Konuş,Görüş</h5>
          <p className="text-2xl font-normal">Aşka açılan kapı</p>
          <div className="flex absolute  -translate-x-1/2 bottom-32">
            <div>
              <img
                src={Image8}
                alt="ateş"
                className="h-[45px] w-[45px] rounded-full border-4 border-white object-cover"
              />
            </div>
            <div>
              <img
                src={Image3}
                alt="damla"
                className="scale-x-[-1] h-[45px] w-[45px] rounded-full border-4 border-white object-cover absolute left-8"
              />
            </div>
            <div>
              <img
                src={Image5}
                alt="ahsen"
                className="scale-x-[-1] h-[45px] w-[45px] rounded-full border-4 border-white object-cover absolute left-16"
              />
            </div>
          </div>
        </div>
