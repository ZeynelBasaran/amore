      ...
      <header className="container text-white bg-background-primary h-[960px] flex flex-col items-center p-14">
        <nav className="bg-fourth w-[751px] h-[66px] rounded-3xl">
          <ul className="w-[751px] h-[66px] flex items-center justify-between text-sm px-4">
            ...
            <li className="bg-secondary w-[125px] h-[48px] rounded-4xl flex justify-center items-center">
              <a href="#">Oturum Aç</a>
            </li>
            <li className="bg-primary w-[125px] h-[48px] rounded-4xl flex justify-center items-center">
              <a href="#" className="">
                Kayıt Ol
              </a>
            </li>
        ...
        <section className="relative mt-10">
          ...
          <div className="bg-primary w-[307px] h-[152px] rounded-3xl flex flex-col items-start justify-center p-6 absolute bottom-[150px] left-[-400px] transform rotate-[-6.64deg]">
            <h5 className="text-3xl">Sadece gerçek insanlar</h5>
            <p className="text-sm">Amore&apos;da sahte hesaplara yer yok</p>
          </div>

          <div className="bg-secondary w-[307px] h-[152px] rounded-3xl flex flex-col items-center justify-center absolute  bottom-[150px] right-[-400px] ransform -rotate-[-6.64deg]">
