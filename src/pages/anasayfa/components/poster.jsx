                ...
                <div className="flex flex-col items-center">
                    <div className="w-[233px] h-[72px] rounded-4xl bg-white flex items-center justify-center mb-3">
                        <svg width="210" height="57" viewBox="0 0 210 57" fill="none" xmlns="http://www.w3.org/2000/svg" className="">
                            <circle cx="182" cy="28.2535" r="28" fill="#DD88CF" />
                            <path d="M193.083 25.495C193.072 22.5365 191.52 19.7542 188.459 18.7684C186.358 18.0903 184.069 18.4674 182.292 21.0195C180.514 18.4674 178.225 18.0903 176.124 18.7684C173.064 19.7543 171.511 22.5371 171.5 25.496C171.472 31.3803 177.434 35.8831 182.29 38.0353L182.292 38.0346L182.293 38.0353C187.149 35.883 193.112 31.3798 193.083 25.495Z" stroke="white" strokeWidth="2" strokeLinecap="square" />
                            <circle cx="105" cy="28.2535" r="28" fill="#412A78" />
                            <path fillRule="evenodd" clipRule="evenodd" d="M106.288 19.1268L108.42 23.386C108.629 23.8041 109.033 24.094 109.5 24.1611L114.27 24.8476C115.448 25.0178 115.917 26.4459 115.064 27.2642L111.615 30.5781C111.276 30.904 111.122 31.3724 111.202 31.8325L112.016 36.511C112.217 37.6684 110.985 38.5514 109.931 38.0039L105.669 35.7934C105.251 35.5765 104.75 35.5765 104.331 35.7934L100.069 38.0039C99.0153 38.5514 97.7835 37.6684 97.9851 36.511L98.7978 31.8325C98.878 31.3724 98.7237 30.904 98.3848 30.5781L94.936 27.2642C94.0832 26.4459 94.5521 25.0178 95.7304 24.8476L100.5 24.1611C100.967 24.094 101.372 23.8041 101.581 23.386L103.712 19.1268C104.239 18.0736 105.761 18.0736 106.288 19.1268Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            <circle cx="28" cy="28.2535" r="27.5" fill="#F9F9F9" stroke="#EBE9E1" />
                            <path d="M21 21.2535L35 35.2535" stroke="#18181C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M35 21.2535L21 35.2535" stroke="#18181C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>

                    </div>

                    <button className="w-[299px] h-[60px] bg-secondary text-white flex justify-center items-center rounded-t-3xl text-lg font-semibold">
                        <svg width="29" height="28" viewBox="0 0 29 28" fill="none" xmlns="http://www.w3.org/2000/svg" className="mr-2">
                            <path fillRule="evenodd" clipRule="evenodd" d="M22.2758 22.1361C19.0678 25.3451 14.3138 26.0387 10.4271 24.2406C9.85268 24.009 9.38159 23.8228 8.93433 23.8228C7.68795 23.8297 6.1362 25.0386 5.33024 24.2327C4.5243 23.4266 5.73322 21.875 5.73322 20.6217C5.73322 20.1734 5.55387 19.7114 5.32344 19.1359C3.52423 15.2491 4.21894 10.4962 7.42686 7.28716C11.5236 3.19155 18.179 3.19155 22.2758 7.28716C26.3793 11.3919 26.3725 18.0393 22.2758 22.1361Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M19.5187 15.03V15.1114M19.8486 15.0475C19.8486 15.2308 19.7 15.3794 19.5166 15.3794C19.3333 15.3794 19.1848 15.2308 19.1848 15.0475C19.1848 14.8642 19.3333 14.7156 19.5166 14.7156C19.7 14.7156 19.8486 14.8642 19.8486 15.0475Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M14.8453 15.03V15.1114M15.1753 15.0475C15.1753 15.2308 15.0266 15.3794 14.8433 15.3794C14.66 15.3794 14.5115 15.2308 14.5115 15.0475C14.5115 14.8642 14.66 14.7156 14.8433 14.7156C15.0266 14.7156 15.1753 14.8642 15.1753 15.0475Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M10.1717 15.03V15.1114M10.5017 15.0475C10.5017 15.2308 10.353 15.3794 10.1697 15.3794C9.98641 15.3794 9.83789 15.2308 9.83789 15.0475C9.83789 14.8642 9.98641 14.7156 10.1697 14.7156C10.353 14.7156 10.5017 14.8642 10.5017 15.0475Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
